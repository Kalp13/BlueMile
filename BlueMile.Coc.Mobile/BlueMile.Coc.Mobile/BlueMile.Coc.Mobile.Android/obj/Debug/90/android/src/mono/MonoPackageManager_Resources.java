...
public class MonoPackageManager_Resources {
	public static String[] Assemblies = new String[]{
		/* We need to ensure that "BlueMile.Coc.Mobile.Android.dll" comes first in this list. */
		"BlueMile.Coc.Mobile.Android.dll",
		"Acr.UserDialogs.dll",
		"AndHUD.dll",
		"BlueMile.Coc.Mobile.dll",
		"FormsViewGroup.dll",
