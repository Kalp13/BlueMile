...
{
    public class ItemTypeListDescriptionConverter : IValueConverter
    {
        public object Convert(object value, Type targetType, object parameter, CultureInfo culture)
        {
            ...
            return GetDescription((List<ItemTypeStaticEntity>)value);
        }
        ...
        public static List<string> GetDescription(List<ItemTypeStaticEntity> enumList)
        {
