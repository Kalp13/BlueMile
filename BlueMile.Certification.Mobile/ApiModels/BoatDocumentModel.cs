...
{
    public class BoatDocumentModel
    {
        /// <summary>
        ...
        /// <summary>
        /// Gets or sets the unique file name for the current <see cref="BoatDocumentModel"/> 
        ...
        /// the current <see cref="BoatDocumentModel"/>.
        /// </summary>
    ...
    public class UpdateBoatDocumentModel
    {
        /// <summary>
        /// Gets or sets the unique identifier of the document.
        /// </summary>
